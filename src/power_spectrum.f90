...
!     only in power_xy and power.
      ...
      nk_xy = nint( sqrt( ((nxgrid+1)/Lx)**2+((nygrid+1)/Ly)**2 )*L_min_xy/2 )+1 !KG: I don't agree with this expression, but I am doing this to avoid changing the behaviour of power_xy.
!
