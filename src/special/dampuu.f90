...
!
      if (x_1==impossible) then x_1=xyz0(1)
      if (y_1==impossible) then y_1=xyz0(2)
      if (z_1==impossible) then z_1=xyz0(3)
      if (x_2==impossible) then x_2=xyz1(1)
      if (y_2==impossible) then y_2=xyz1(2)
      if (z_2==impossible) then z_2=xyz1(3)
!
      tauinv_prof = step(x,x_1,-w)*step(x,x_2,w) &
                   *step(y,y_1,-w)*step(y,y_2,w) &
                   *step(z,z_1,-w)*step(z,z_2,w) &
                   /tau
