...
!
        case('from_file')
          force(:,1) = ampl_ff(i)*forcing_cont_from_file(1,l1-nghost:l2-nghost,m-nghost,n-nghost)
          force(:,2) = ampl_ff(i)*forcing_cont_from_file(2,l1-nghost:l2-nghost,m-nghost,n-nghost)
          force(:,3) = ampl_ff(i)*forcing_cont_from_file(3,l1-nghost:l2-nghost,m-nghost,n-nghost)
!
